...
class PRPALN
{
	...
	throws Exception
	{
		...
		while(T-->0)
		{
			...
			{
				String str1 = str.substring(0, x) + str.substring(x + 1);
				x = len-(x+1);
				String str2 = str.substring(0, x) + str.substring(x + 1);

				int p = a.palindrome(str1);
				int q = a.palindrome(str2);
